...
Целью данного проекта является разработка web-интерфейса для простой CRM системы, в которой должны быть следующие возможности:
- Просмотр списка людей в виде таблицы с возможностью сортировки и поиска
- Добавление нового клиента
- Изменение информации о существующем клиенте

![4wWIVnRJWj](https://user-images.githubusercontent.com/79591409/175536403-3993d306-40e4-4e5c-9635-dc2f31f887a2.gif)
